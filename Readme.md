...
# Parsing + Configuration Script – Milesight UC100 + Circutor CVM-E3-Mini - Rev. A

This **Parsing + Configuration** script is designed for the **Milesight UC100 + Circutor CVM-E3-Mini** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Milesight UC100 + Circutor CVM-E3-Mini Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Milesight UC100 + Circutor CVM-E3-Mini** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
